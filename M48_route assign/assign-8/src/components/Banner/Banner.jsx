...
const Banner = () => {
    return (
        <div className='mt-5 px-4 text-center items-center'>
            <h1 className='text-4xl sm:text-6xl font-bold'>Dependable Care, Backed by Trusted <br /> Professionals.</h1>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center mt-4 gap-4'>
                <input
                    className='rounded-2xl w-full sm:w-96 h-10 px-4 border border-gray-300'
                    type="text"
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center mt-5 gap-4'>
                <img className='w-full max-w-sm lg:w-[620px] rounded-lg' src={BannerImg} alt="Doctor" />
                <img className='w-full max-w-sm lg:w-[620px] rounded-lg' src={BannerImg} alt="Doctor" />
            </div>
        </div>
    );
